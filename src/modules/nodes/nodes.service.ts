        ...
        properties: [
          {
            ...
            description: "URL path for this webhook (e.g., /new-order)",
          },
          {
            name: "method",
            label: "HTTP Method",
          ...
          },
          {
            ...
            description: "Required for headerAuth",
          },
          {
            name: "authQueryValue",
            label: "Auth Query Value",
            type: "string",
            placeholder: "your-secret-key",
            description: "Required for queryAuth",
          },
        ],
      },
      {
      ...
      // ============= DATA TRANSFORMATION NODES =============
      {
        ...
        properties: [
          ...
          },
          {
            ...
            label: "Bearer Token",
            type: "string",
            placeholder: "For Bearer Token Auth",
          },
          {
            name: "apiKey",
            label: "API Key",
            type: "string",
            placeholder: "For API Key Auth",
          },
          {
            name: "apiKeyHeader",
